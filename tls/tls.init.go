...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "caKeyAlgorithmInput", GoGetter: "CaKeyAlgorithmInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetCaKeyAlgorithm", GoMethod: "ResetCaKeyAlgorithm"},
